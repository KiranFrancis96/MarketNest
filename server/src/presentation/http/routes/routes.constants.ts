...
export const ROUTE_MERCHANT_UPDATE_PROFILE = "/profile";
...
export const BASE_PROFILE_ROUTE = "/api/profile";

export const ROUTE_PROFILE_BASE = "/";

export const ROUTE_PROFILE_LIFESTYLE = "/lifestyle";

export const ROUTE_PROFILE_FAMILY = "/family";

export const ROUTE_PROFILE_HOME = "/home";

export const ROUTE_PROFILE_SHOPPING = "/shopping";

export const ROUTE_PROFILE_PRIVACY = "/privacy";
